...
cylIds.append(O.bodies.append( gridConnection(nodesIds[0],nodesIds[1],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[1],nodesIds[2],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[0],nodesIds[2],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[2],nodesIds[3],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[0],nodesIds[3],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[1],nodesIds[5],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[5],nodesIds[2],rWall,color=color) ))


cylIds.append(O.bodies.append( gridConnection(nodesIds[5],nodesIds[6],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[2],nodesIds[6],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[7],nodesIds[6],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[4],nodesIds[6],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[4],nodesIds[7],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[0],nodesIds[4],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[3],nodesIds[7],rWall,color=color) ))
cylIds.append(O.bodies.append( gridConnection(nodesIds[5],nodesIds[4],rWall,color=color) ))

cylIds.append(O.bodies.append( gridConnection(nodesIds[3],nodesIds[4],rWall,color=color) ))
