...
#strainStressValues=[(0.005,8.00E+08),(0.01,1.50E+09),(0.015,1.85E+09),(0.02,1.95E+09),(0.027,1.95E+09),(0.035,1.50E+09)]


strainStressValues=[(0.0125,1.85E+09),(0.027,1.7E+09),(0.035,1.0E+09)]
#strainStressValues=[(0.015,1.85E+09),(0.027,1.95E+09),(0.035,1.0E+09)]
...
print y0/1e9, y1/1e9, y2/1e9

strainStressValues=[(x0,y0),(x1,y1),(x2,y2)]


print strainStressValues
...
meshMatInternal = O.materials.append( WireMat( young=young,poisson=poisson,frictionAngle=radians(fricangle),density=density,isDoubleTwist=False,diameter=d,strainStressValues=strainStressValues,lambdaF=lambdaF, lambdau=lambdau,seed=123,type=2) )

strainD0=-5
strainDF=strainD0-5

print strainD0,strainDF

O.tags['description']='sscurve_ttest2_y0_'+str(y0/1e9)+'_a1_'+str(a1)+'_a2_'+str(a2)+'lambdaF_'+str(lambdaF)+'_lambdau_'+str(lambdau)
...
#VTKRecorder(iterPeriod=1000,initRun=True,fileName='paraview/'+O.tags['description']+'/'+O.tags['description']+'-',recorders=['wpm','spheres','velocity','intrs','materialId']),
...
for i in O.interactions:
	i.phys.strainD0=strainD0
	i.phys.strainDF=strainDF
...
def addPlotData():
	...
	un = (O.bodies[posIds[0]].state.pos[1] - O.bodies[posIds[0]].state.refPos[1])
	eps=un/L
