...
###################### 	
def dataCollector():
	plot.addData(t1=O.time,t2=O.time,unbF=unbalancedForce(),y1=O.bodies[0].state.pos[1],y2=O.bodies[1].state.pos[1],y3=O.bodies[6].state.pos[1],y4=O.bodies[7].state.pos[1],vy=O.bodies[nodesIds1[0]].state.vel[1])
